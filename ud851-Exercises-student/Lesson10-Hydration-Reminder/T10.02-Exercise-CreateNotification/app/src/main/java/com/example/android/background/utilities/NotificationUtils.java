...
public class NotificationUtils {
    ...
    private static final int NOTIF_CONST = 2;
    ...
    // https://developer.android.com/training/notify-user/build-notification.html
        ...
        // Pass in a unique ID of your choosing for the notification and notificationBuilder.build()
            Nmanager.notify(NOTIF_CONST,mBuilder.build());
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, INTENT_CONST, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
    ...
    private static Bitmap largeIcon(Context context) {
        ...
        Resources resc = Resources.getSystem();
        // TODO (6) Create and return a bitmap using BitmapFactory.decodeResource, passing in the
        // resources object and R.drawable.ic_local_drink_black_24px

        return BitmapFactory.decodeResource(resc,R.drawable.ic_local_drink_black_24px);
    }
